...
SQL is the language and Relational Databases are a type of Database that you can create and manipulate with SQL
...
join table normalizes tables so they dont duplicate data. 
